...
#if (defined CONFIG_PROJECT_P7701)||(defined CONFIG_PROJECT_P7705)||(defined CONFIG_PROJECT_GARLIC)||(defined CONFIG_PROJECT_P7203) //MYOSC-710.前后闪光灯都设置为长亮，切换前后置摄像头，有时前置闪光灯不亮.wupingzhou,20160611.
#else
	if (fctrl->flash_driver_type == FLASH_DRIVER_DEFAULT)
